...
ROOMS = {
    ...
    'hall': {
        ...
        'exits': {'south': 'entrance', 'west': 'library', 'north': 'treasure_room', 'east': 'toilet'},
        'items': [],
        'puzzle': {
            'question': 'На пьедестале надпись: "Назовите число, которое идет после девяти". Введите ответ цифрами.',
            'answers': {'10', 'десять'},
            'reward': 'coin'
        }
    },
    ...
    'kitchen': {
        'description': 'Кухня. На столе холодный суп, в углу ведро. Кто-то явно тут жил.',
        'exits': {'east': 'entrance'},
        'items': ['knife', 'bread'],
        'puzzle': {
